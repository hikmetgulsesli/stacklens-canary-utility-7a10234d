...
- StackLens Canary Utility turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact operations dashboard called StackLens Canary Utility. It should be a browser app for tracking module stack health across web, game, mobile, backend, and data pipelines. Show stack modules, ownership boundaries, build/test status, failure routing, and recovery notes. This is not a game.
...
- Record Operations - StackLens Canary Utility
- Record Editor - StackLens Canary Utility
- Insights - StackLens Canary Utility
- Empty and Error Recovery - StackLens Canary Utility

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - StackLens Canary Utility
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - StackLens Canary Utility
...
SCREEN_SPEC_3:
- exact_screen_title: Insights - StackLens Canary Utility
...
SCREEN_SPEC_4:
- exact_screen_title: Empty and Error Recovery - StackLens Canary Utility
